...
aPixelBuffer* LinuxGTKAngelo::GeneratePixelBuffer(uView* view) {
...
void LinuxGTKAngelo::BindRenderTarget(aPixelBuffer* buffer) {
...
void LinuxGTKAngelo::UnBindRenderTarget() { 
    glBindFramebuffer(GL_FRAMEBUFFER, 0);
    glBindTexture(GL_TEXTURE_2D, 0);
}