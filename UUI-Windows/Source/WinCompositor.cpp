//  WinCompositor.cpp   first written by sebhall in March 2023
...
bool WinCompositor::SetupForCompositing() {
...
aPixelBuffer* WinCompositor::CompositeBuffers(uSize extents, std::vector<aPixelBuffer*> inputBuffers) {
