...
if ($MODE -eq "-STATIC") {
    ...
    g++ -DUUI_BUILD .\App\main.cpp @XP_SRC_ARGS @DP_SRC_ARGS -o .\Build\main.exe -Wall -g -mconsole -lglu32 -lgdi32 -lopengl32  -I.\Include -I.\..\ --static -static-libgcc -static-libstdc++
    Write-Output "DONE!"
