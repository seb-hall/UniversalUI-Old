...
bool WinRenderer::InitialiseRenderer() {
...
void WinRenderer::RenderView(uView* view) {
...
void WinRenderer::RenderWindow(uWindow* window) {
...
aPixelBuffer WinRenderer::NewPixelBuffer(uSize size) {
...
void WinRenderer::ResizePixelBuffer(aPixelBuffer buffer, uSize size) {
...
void WinRenderer::ClearBuffer(aPixelBuffer buffer, uColour colour) {
